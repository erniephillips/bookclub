...
public interface GenericDao<E, K> {
  List<E> list(K key); //return a list of objects for the entity type represented by (E)
  E find(K key); //return the entity (E) object once obtained by the Key represented by (K)
}
